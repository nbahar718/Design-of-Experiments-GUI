...
class DOEApp:
    ...
    def __init__(self, master):
        ...
        openExcelFile = tk.Button(frame, text="Open Excel File", padx=10, pady=5, fg="white", bg="#263D42",
        ...
        tk.Button(frame, text="Confirm DOE Methods and Open Output File", padx=10, pady=5, fg="white", bg="#263D42",
    ...
    def open_csv_file(self):
        ...
        csvfilepath = filedialog.askopenfilename(title="Choose Source CSV File",
                                                ...
                                                filetypes=(("Comma-separated values (CSV) files","*.csv"),
